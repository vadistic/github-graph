...
export type RepositoryBaseQueryVariables = {
  ids: Array<Scalars['ID']>
}

export type RepositoryBaseQuery = {
  __typename?: 'Query'
  nodes: Array<
    Maybe<
      | { __typename?: 'CodeOfConduct' }
...
export type UserStarsByLoginQueryVariables = {
  login: Scalars['String']
  after?: Maybe<Scalars['String']>
}

export type UserStarsByLoginQuery = {
  __typename?: 'Query'
  user: Maybe<{
    __typename?: 'User'
    id: string
...
export type UserStarsByIdQueryVariables = {
  id: Scalars['ID']
  after?: Maybe<Scalars['String']>
}

export type UserStarsByIdQuery = {
  __typename?: 'Query'
  node: Maybe<
    | { __typename?: 'CodeOfConduct' }
    | { __typename?: 'Enterprise' }
